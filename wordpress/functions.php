...
function wordpress_scripts() {
    ...
    wp_enqueue_style( 'wordpress-main', get_template_directory_uri() . '/main.css' );

    wp_enqueue_script( 'wordpress-header-menu', get_template_directory_uri() . '/assets/js/header-menu.js', array(), '20151215', true );

    wp_enqueue_script( 'wordpress-index', get_template_directory_uri() . '/assets/js/index.js', array(), '20151215', true );
